            ...
            <div className="w-full lg:w-[310px] flex flex-col gap-3.5 pointer-events-auto lg:max-h-full overflow-y-visible lg:overflow-y-auto lg:pr-1 shrink-0">
              ...
              <div className="glass-panel p-4 rounded-xl space-y-4">
                <h3 
                  ...
                  className="text-xs font-bold text-sky-400 uppercase tracking-widest flex items-center gap-2 border-b border-slate-900 pb-2 mb-1.5 cursor-pointer select-none"
                >
                  <Filter size={13} />
